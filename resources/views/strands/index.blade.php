        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="display:flex; justify-content:end; gap:1rem; width: 100%; padding-right:6.5rem;" scope="col">Action</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td>{{ $strand->name }}</td>
                    <td style="display:flex; justify-content:end; gap:1rem; width: 100%;">
