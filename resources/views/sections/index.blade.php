...
<div class="container-div">
    ...
    <div class="st">
        ...
        <div style="padding:5px; display:flex; justify-content:end; padding-right: 2rem;">
            <a class="btn btn-primary" href="{{ route('sections.create') }}" role="button">Add New Section</a>
        </div>
        <table class="table">
            <thead>
                <tr>
                ...
                @foreach ($sections as $section)
                    <tr>
                        ...
                        <td style="display:flex; gap:1rem;">
                            ...
                            <a href="{{ route('sections.edit', $section->id) }}" class="btn btn-secondary btn-sm">Edit</a>
