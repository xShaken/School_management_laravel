...
<div class="container">
    ...
    <a href="{{ route('sections.index') }}" class="btn btn-secondary">Back to List</a>
    <a href="{{ route('sections.edit', $section->id) }}" class="btn btn-primary">Edit Section</a>
    ...
    <h2>Strand: {{ $section->strand_name }}</h2>
</div>
@endsection
